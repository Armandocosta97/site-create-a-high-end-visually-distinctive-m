  ...
  contact: {
    ...
    details: {
      ...
      form: {
        ...
        sendingLabel: "Envoi...",
        successMessage: "Demande envoyée avec succès. Nous vous répondrons dès que possible.",
        successSheetTitle: "Demande envoyée avec succès",
        successSheetCloseLabel: "Fermer la confirmation d'envoi",
        errorMessage: "L'envoi a échoué. Réessayez dans un instant ou contactez-nous par email/WhatsApp.",
